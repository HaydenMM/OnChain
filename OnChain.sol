...
contract TheStripesNFT is ERC721Enumerable, Ownable {
    ...
    string[] head_2 = [
        "<style>tspan { white-space:pre }.s19 { fill: #0059ff } </style><g ><path class='s19' d='m249.5 357c-59.45 0-107.5-48.05-107.5-107.5c0-59.45 48.05-107.5 107.5-107.5c59.45 0 107.5 48.05 107.5 107.5c0 59.45-48.05 107.5-107.5 107.5z' /></g>", 
    ...
    string[] petal_1_2 = [
        ...
        "<style>tspan { white-space:pre }.s33 { fill: #9100ff } </style><g ><g ><path class='s33' d='m250 148c-16.59 0-30-13.41-30-30c0-16.59 13.41-30 30-30c16.59 0 30 13.41 30 30c0 16.59-13.41 30-30 30z' /></g></g>",
        "<style>tspan { white-space:pre }.s33 { fill: #00c5ff } </style><g ><g ><path class='s33' d='m250 148c-16.59 0-30-13.41-30-30c0-16.59 13.41-30 30-30c16.59 0 30 13.41 30 30c0 16.59-13.41 30-30 30z' /></g></g>",
    ...
    function pickRandomPetal_1_1(uint256 tokenId)
        public
        view
        returns (string memory)
    {
        uint256 rand = random(
            string(abi.encodePacked("PETAL_1_1", Strings.toString(tokenId)))
        );
        rand = rand % petal_1_1.length;
        return petal_1_1[rand];
    }

    function pickRandomPetal_1_2(uint256 tokenId)
        public
        view
        returns (string memory)
    {
        uint256 rand = random(
            string(abi.encodePacked("PETAL_1_2", Strings.toString(tokenId)))
        );
        rand = rand % petal_1_2.length;
        return petal_1_2[rand];
    }
    
    // Generate Head
    function pickRandomHead_1_1(uint256 tokenId)
        public
        view
        returns (string memory)
    {
        uint256 rand = random(
            string(abi.encodePacked("HEAD_1", Strings.toString(tokenId)))
        );
        rand = rand % head_1.length;
        return head_1[rand];
    }

    
    function pickRandomHead_1_2(uint256 tokenId)
        public
        view
        returns (string memory)
    {
        uint256 rand = random(
            string(abi.encodePacked("HEAD_2", Strings.toString(tokenId)))
        );
        rand = rand % head_2.length;
        return head_2[rand];
    }
